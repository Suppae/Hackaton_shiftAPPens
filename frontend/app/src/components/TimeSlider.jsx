...
export default function TimeSlider() {
  ...
  return (
    <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-10"
      style={{ width: 420 }}>
      <div className="bg-black/70 backdrop-blur-md rounded-xl px-5 py-3 border border-red-500/10">
        <div className="flex items-center gap-3">
          <button
            ...
            style={{ background: isPlaying ? '#ef4444' : '#dc2626' }}
          >
            {isPlaying ? (
          ...
          <span className="font-mono text-sm text-red-400 flex-shrink-0 w-20 text-right">
            {minutesLabel}
          </span>
        </div>
      </div>
